    ...
    <div className="advice-card">
      <div className="advice-header">
        <div className="advice-title">
          <span style={{ color: '#6E4F96' }}>✦</span> Claude 소비 조언
        </div>
...
export function NextMonthCard({ allTransactions, year, month }) {
  ...
  if (!pred) {
    return (
      <div className="advice-card">
        <div className="advice-header">
          <div className="advice-title">
            <span style={{ color: '#A88AC7' }}>◈</span> 다음 달 예측
          </div>
  ...
  const items = [
    ...
    isDeficit
      ...
      : {
          icon: savingRate >= 30 ? '🎯' : '💡',
          color: savingRate >= 30 ? '#8261A8' : '#B58BD0',
  ...
  return (
    <div className="advice-card">
      ...
      <div style={{
        ...
        borderRadius: 8, fontSize: 11, color: '#A88AC7', lineHeight: 1.5,
      }}>
